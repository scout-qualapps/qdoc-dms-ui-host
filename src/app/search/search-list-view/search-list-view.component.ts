...
const ELEMENT_DATA: PeriodicElement[] = [
    ...
    {position: 2, img: '', name: 'folder 2', folder: "",Repository:"Repository B", folderColor: "green", DateModified: '01/05/2022 3:30 PM', ModifiedBy: 'Jone, Adam Jone', gridListNav:'gg', isFolder:true},
