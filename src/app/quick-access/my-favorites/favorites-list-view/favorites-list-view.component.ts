...
const ELEMENT_DATA: PeriodicElement[] = [
    {position: 1, img: '', name: 'folder 1', folder: "", Repository:"Repository A",folderColor: "",  DateModified: '01/05/2022 3:30 PM', ModifiedBy: 'Jone, Adam', gridListNav:'gg', isFolder:true},
    {position: 2, img: '', name: 'folder 2', folder: "",Repository:"Repository B", folderColor: "green", DateModified: '01/05/2022 3:30 PM', ModifiedBy: 'Jone, Adam', gridListNav:'gg', isFolder:true},
    {position: 3, img: '', name: 'folder 3', folder: " ",Repository:"Repository C", folderColor: "", DateModified: '01/05/2022 3:30 PM', ModifiedBy: 'Jone, Adam ', gridListNav:'gg', isFolder:true },
...
@Component({
  selector: 'app-favorites-list-view',
  templateUrl: './favorites-list-view.component.html',
  styleUrls: ['./favorites-list-view.component.scss']
})
export class FavoritesListViewComponent implements OnInit {
