...
@Component({
  selector: 'app-file-edit-properties-modal',
  templateUrl: './file-edit-properties-modal.component.html',
  styleUrls: ['./file-edit-properties-modal.component.scss']
})
export class FileEditPropertiesModalComponent implements OnInit {
